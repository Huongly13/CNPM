  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        -->
        <li class="<?php if($p == 'tai_khoan') echo 'active'; ?> treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="<?php if($a == 'profile') echo 'active'; ?>"><a href="thong-tin-tai-khoan.php?p=tai_khoan&a=profile"><i class="fa fa-circle-o"></i> Thông tin tài khoản</a></li>
            <li class="<?php if($a == 'add-tai_khoan') echo 'active'; ?>"><a href="tao-tai-khoan.php?p=tai_khoan&a=add-tai_khoan"><i class="fa fa-circle-o"></i> Tạo tài khoản</a></li>
            <li class="<?php if(($p == 'tai_khoan') && ($a == 'list-tai_khoan')) echo 'active'; ?>"><a href="ds-tai-khoan.php?p=tai_khoan&a=list-tai_khoan"><i class="fa fa-circle-o"></i> Danh sách tài khoản</a></li>
            <li class="<?php if($a == 'changepass') echo 'active'; ?>"><a href="doi-mat-khau.php?p=tai_khoan&a=changepass"><i class="fa fa-circle-o"></i> Đổi mật khẩu</a></li>
