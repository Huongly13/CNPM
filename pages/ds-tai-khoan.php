...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['edit']))
  {
    $id = $_POST['idtai_khoan'];
    echo "<script>location.href='sua-tai-khoan.php?p=tai_khoan&a=list-tai_khoan&id=".$id."'</script>";
  }
  ...
  if(isset($_POST['delete']))
  {
    ...
    // check tai_khoan using then cannot delete
    if($id == $row_acc['id'])
    ...
    if(!$error)
    {
      ...
      $success['success'] = 'Xóa tài khoản thành công.';
        echo '<script>setTimeout("window.location=\'ds-tai-khoan.php?p=tai_khoan&a=list-tai_khoan\'",1000);</script>';
    }
      ...
      <div class="modal-content">
        <form method="POST">
          ...
          <div class="modal-body">
            <input type="hidden" name="idtai_khoan">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="ds-tai-khoan.php?p=tai_khoan&a=list-tai_khoan">Tài khoản</a></li>
                        ...
                        <th>
                          <?php 
                            if($row_acc['quyen'] == 1)
                            {
                              ...
                              echo "<input type='hidden' value='".$arrS['id']."' name='idtai_khoan'/>";
