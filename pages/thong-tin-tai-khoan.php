  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      if($image)
      {
        ...
        echo '<script>setTimeout("window.location=\'thong-tin-tai-khoan.php?p=tai_khoan&a=profile\'",1000);</script>';
      }
      else
      {
        // update record
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="thong-tin-tai-khoan.php?p=tai_khoan&a=profile">Tài khoản</a></li>
