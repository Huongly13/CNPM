  ...
  if(isset($_POST['save']))
  {
    ...
    if(!$error)
    {
      ...
      if($image)
      {
        ...
        // insert record
        $insert = "INSERT INTO tai_khoan(ho, ten, hinh_anh, email, mat_khau, so_dt, quyen, trang_thai, ngay_sua, ngay_tao) VALUES('$lastName', '$firstName', '$nameImage', '$email', '$password', '$phone', $level, $status, $access, '$date_create', '$date_update')";   
        ...
        echo '<script>setTimeout("window.location=\'tao-tai-khoan.php?p=tai_khoan&a=add-tai_khoan\'",1000);</script>';
      }
      else
      {
        $nameImage = 'ad.png';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tao-tai-khoan.php?p=tai_khoan&a=add-tai_khoan">Tài khoản</a></li>
